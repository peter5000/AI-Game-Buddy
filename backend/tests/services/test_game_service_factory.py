...
def test_get_service_creates_different_instances_for_different_games(game_factory: GameServiceFactory):
    """
...
def test_get_service_raises_error_for_unknown_game_type(game_factory: GameServiceFactory):
    """
