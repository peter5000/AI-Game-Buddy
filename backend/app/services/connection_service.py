...
class ConnectionService:
    ...
    async def publish_event(self, channel: str, user_list: set[str], message_data: dict):
        message = {
            "channel": channel,
            "payload": {
                "user_list": user_list,
        ...
        await self.redis_service.publish_message(channel=self.pubsub_channel, message=json.dumps(message))
