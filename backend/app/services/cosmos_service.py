...
class CosmosService:
    def __init__(self):
        ...
        self.chat_rooms_container_client = db_client.get_container_client("chats")
    ...
    def get_container(self, container_type: str):
        ...
        elif container_type == "chats" or container_type == "chat_rooms":
            return self.chat_rooms_container_client
        else:
