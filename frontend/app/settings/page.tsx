                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Get notified when someone invites you to a game</p>
                    </div>
                    <Switch
                      id="game-invites"
                      checked={notifications.gameInvites}
                      onCheckedChange={(checked) => handleNotificationToggle("gameInvites", checked)}
                    />
                  </div>

                  <div className="flex items-center justify-between">
                    <div>
                      <Label htmlFor="game-results">Game Results</Label>
                      <p className="text-sm text-gray-600">Notifications about your game outcomes</p>
                    </div>
                    <Switch
                      id="game-results"
                      checked={notifications.gameResults}
                      onCheckedChange={(checked) => handleNotificationToggle("gameResults", checked)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Notifications for new friend requests</p>
                    </div>
                    <Switch
                      id="friend-requests"
                      checked={notifications.friendRequests}
                      onCheckedChange={(checked) => handleNotificationToggle("friendRequests", checked)}
                    />
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="game-history-visibility">Game History Visibility</Label>
                    <Select
                      value={privacy.gameHistoryVisibility}
                      onValueChange={(value) => handlePrivacyUpdate("gameHistoryVisibility", value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => handlePrivacyUpdate("onlineStatus", checked)}
                    />
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-3">
                      Download a copy of your game history, stats, and profile data
                    </p>
                  ...
                  <div>
                    <h4 className="font-medium mb-2">Clear Game History</h4>
                    <p className="text-sm text-gray-600 mb-3">
                      Remove all your game history and statistics (this cannot be undone)
                    </p>
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently delete all your game history, statistics, and achievements. This
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently delete your account, game history, statistics, and all associated
