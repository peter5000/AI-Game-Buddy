                    ...
                    <div>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Set up your game preferences and invite
                                    players
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={selectedAIFriend}
                                        onValueChange={setSelectedAIFriend}
                                    >
                                        <SelectTrigger>
                        ...
                        <Card className="mt-6">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Jump into a game immediately with default
                                    settings
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
