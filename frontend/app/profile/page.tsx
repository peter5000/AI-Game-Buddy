...
export default function ProfilePage() {
    ...
    const achievements = [
        ...
        {
            name: "Strategist",
            description: "Win 5 strategy games in a row",
            earned: false,
        },
        {
            name: "Night Owl",
            description: "Play 50 games after midnight",
            earned: false,
        },
        {
            name: "AI Whisperer",
            description: "Win against all AI personalities",
            earned: false,
        },
    ];
