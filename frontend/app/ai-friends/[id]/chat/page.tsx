    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            ...
            sender: "ai",
            content:
                "Hey there! I'm excited to chat with you. How are you feeling about our next game?",
        ...
        },
        {
            ...
            sender: "ai",
            content:
                "I've been analyzing some new opening strategies. This should be interesting! 🎯 Ready when you are.",
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <Avatar className="w-10 h-10">
                                <AvatarImage
                                    src={aiFriend.avatar || "/placeholder.svg"}
                                />
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    <DropdownMenuItem asChild>
                                        <Link
                                            href={`/ai-friends/${aiFriend.id}/edit`}
                                        >
                    ...
                    <ScrollArea className="h-[calc(100vh-200px)] p-4">
                        <div className="space-y-4">
                            {messages.map((message) => (
                                ...
                                >
                                    <div
                                        className={`flex gap-3 max-w-[70%] ${message.sender === "user" ? "flex-row-reverse" : ""}`}
                                    >
