...
export default function AIFriendsPage() {
    ...
    const aiFriends = [
        ...
        },
        {
            ...
            personality:
                "Bubbly and supportive, always celebrates your victories and helps you learn from defeats",
            avatar: "/placeholder.svg?height=80&width=80",
            gamesPlayed: 28,
        ...
        },
        {
            ...
            name: "Rival Rick",
            personality:
                "Competitive trash-talker who pushes you to your limits with witty banter",
            avatar: "/placeholder.svg?height=80&width=80",
            gamesPlayed: 67,
        ...
        },
        {
            ...
            name: "Sage the Wise",
            personality:
                "Calm and philosophical, offers deep insights about strategy and life",
            avatar: "/placeholder.svg?height=80&width=80",
            gamesPlayed: 89,
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-600">
                            Manage your custom AI companions and their
                            personalities
                        </p>
                    </div>
                        ...
                        >
                            ...
                            <CardContent>
                                ...
                                <div className="flex gap-2 mt-6">
                                    <Link
                                        href={`/ai-friends/${friend.id}/chat`}
                                        className="flex-1"
                                    >
                                        <Button
                                            variant="outline"
                                    ...
                                    <Link
                                        href={`/ai-friends/${friend.id}/invite`}
                                        className="flex-1"
                                    >
                                ...
                                <div className="flex gap-2 mt-2">
                                    <Link
                                        href={`/ai-friends/${friend.id}/edit`}
                                        className="flex-1"
                                    >
                                        <Button
                                            variant="ghost"
