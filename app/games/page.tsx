...
import { Search, Users, Clock, Star, Filter } from "lucide-react"
...
export default function GamesPage() {
  const games = [
    ...
    },
    {
      id: 2,
      name: "Chess",
      description: "The timeless strategy game with AI opponents of varying skill levels",
      players: "2",
      difficulty: "Hard",
      duration: "15-60 min",
      rating: 4.8,
    ...
    },
    {
      id: 3,
      name: "Lands",
      description: "Custom territory control game with resource management",
      players: "2-4",
      difficulty: "Medium",
      duration: "20-30 min",
      rating: 4.5,
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Choose from our collection of games and play with AI companions</p>
        </div>
          ...
          {games.map((game) => (
            <Card key={game.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6">
                ...
                <CardDescription className="mb-4 line-clamp-2">{game.description}</CardDescription>
